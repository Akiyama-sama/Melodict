  ...
  return (
    ...
    >
          ...
          <div className="song-controls-container flex h-fit justify-center items-center">
            ...
            <div
              className={`volume-slider-container invisible mr-4 min-w-[4rem] max-w-[6rem] opacity-0 transition-[visibility,opacity] delay-150 ease-in-out lg:mr-4 ${isMouseActive && 'group-hover/songControlContainer:visible group-hover/songControlContainer:opacity-100'}`}
            >
